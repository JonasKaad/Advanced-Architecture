...
\author{
    \IEEEauthorblockN{
        Sebastian Mondrup\IEEEauthorrefmark{1},
        Victor Andreas Boye\IEEEauthorrefmark{1},
        Jonas Solhaug Kaad\IEEEauthorrefmark{1},
        Rasmus Enemark Jacobsen\IEEEauthorrefmark{1},\\
        Patrick Holmquist Andreasen\IEEEauthorrefmark{1}, Alexander Nørup\IEEEauthorrefmark{1}
    }
    \IEEEauthorblockA{
        University of Southern Denmark, SDU Software Engineering, Odense, Denmark \\
        Email: \IEEEauthorrefmark{1} \textnormal{\{semon20,viboy20,jokaa17,rasmj20,pandr20,alnoe20\}}@student.sdu.dk
    }
}
...
\begin{IEEEkeywords}
Software Architecture, Keyword2, Keyword3, Keyword4, Keyword5
\end{IEEEkeywords}
